...
## [0.3.3] - 2025-01-09 (Вечер)

### ✨ Добавлено
- **Вход в огненную пещеру** - новый финиш первого уровня вместо флага
  - Сгенерированная AI пещера с лавой
  - Анимированное свечение и дым
  - Триггер завершения внутри пещеры
- **Обновлённый Рик Санчез** - векторная версия персонажа (не пиксельная)
- **Публичный доступ через LocalTunnel** - возможность делиться игрой через интернет
- **Настройка громкости монеток** - установлена на 15% по умолчанию

### 🐛 Исправлено
- **Наложение иконок PowerUp** - восстановлено динамическое позиционирование
- **Ползунки настроек звука** - исправлена проблема с невидимым слоем, блокирующим взаимодействие
- **Дублирование методов** - исправлен метод createProfessionalSlider в SettingsModal

### 🔧 Технические изменения
- Добавлена поддержка внешних хостов в vite.config.ts для туннелей
- Оптимизирована логика репозиционирования иконок PowerUp
- Улучшена структура настроек звука
